...
//FUNC::husnanWVarDump($posts["kd_jenis"]);
        ...
        */
        ...
        /*
        if ($tmTglAwal < strtotime('-2 day 0 hours 0 minutes 0 seconds', strtotime('last day of previous month 0 hours 0 minutes 0 seconds')) || $tmTglAwal > strtotime("+3 days 23 hours 59 minutes 59 seconds")) {    
            echo json_encode([
                "status" => "fail",
